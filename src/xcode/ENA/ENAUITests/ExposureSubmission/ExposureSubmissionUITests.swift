...
class ENAUITests_04a_ExposureSubmission: XCTestCase {
	...
	func test_screenshot_test_result_positive() {
		app.launchArguments.append(contentsOf: [LaunchArguments.common.ENStatus, ENStatus.active.stringValue])
		app.launchArguments.append(contentsOf: [LaunchArguments.consent.isPCRSubmissionConsentGiven, YES])
		app.launchArguments.append(contentsOf: [LaunchArguments.test.pcr.pcrPositiveTestResultWasShown, NO])
		app.launchArguments.append(contentsOf: [LaunchArguments.test.pcr.pcrTestResult, TestResult.positive.stringValue])
		launch()
