...
class ENAUITests_07_ContactJournal: XCTestCase {
	...
	override func setUpWithError() throws {
		...
		app.launchArguments.append(contentsOf: [LaunchArguments.contactJournal.journalRemoveAllPersons, YES])
		app.launchArguments.append(contentsOf: [LaunchArguments.contactJournal.journalRemoveAllLocations, YES])
	}
	...
	func testOpenInformationScreenViaSheet() throws {
		app.launchArguments.append(contentsOf: [LaunchArguments.infoScreen.diaryInfoScreenShown, YES])
	...
	func testNavigationToInformationVC() throws {
		app.launchArguments.append(contentsOf: [LaunchArguments.infoScreen.traceLocationsInfoScreenShown, NO])
	...
	func testOverviewScenario1() throws {
		app.launchArguments.append(contentsOf: [LaunchArguments.infoScreen.diaryInfoScreenShown, YES])
		app.launchArguments.append(contentsOf: [LaunchArguments.risk.riskLevel, "low"])
	...
	func testOverviewScenario2() throws {
		...
		app.launchArguments.append(contentsOf: [LaunchArguments.risk.checkinRiskLevel, "high"])
	...
	func testOverviewScenario3() throws {
		app.launchArguments.append(contentsOf: [LaunchArguments.infoScreen.diaryInfoScreenShown, YES])
		app.launchArguments.append(contentsOf: [LaunchArguments.risk.checkinRiskLevel, "low"])
