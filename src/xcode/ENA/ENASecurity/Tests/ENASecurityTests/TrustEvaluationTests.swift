...
class TrustEvaluationTests: XCTestCase {
    ...
    func testFingerprintAndKeyIdentifier() throws {
        ...
        let keyIdentifier = try XCTUnwrap(Data(base64Encoded: "6H4m650iKAE="))
