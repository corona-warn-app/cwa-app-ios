	...
	enum HealthCertificate {
		...
		enum Person {
			...
			enum AdmissionState {
				...
				static let subtitle2GPlus = NSLocalizedString("HealthCertifiedPerson_AdmissionState_subtitle2GPlus", comment: "")
				...
				static let description2GPlus = NSLocalizedString("HealthCertifiedPerson_AdmissionState_description2GPlus", comment: "")
