...
enum AppStrings {
	...
	enum ExposureSubmissionPositiveTestResult {
		...
		static let noConsentAlertButtonLeft = NSLocalizedString("TestResultPositive_NoConsent_AlertNotWarnOthers_ButtonOne", comment: "")
		static let noConsentAlertButtonRight = NSLocalizedString("TestResultPositive_NoConsent_AlertNotWarnOthers_ButtonTwo", comment: "")
