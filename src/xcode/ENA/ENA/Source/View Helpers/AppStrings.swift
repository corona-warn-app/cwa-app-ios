...
enum AppStrings {
	...
	enum ContactDiary {
		...
		enum Information {
			...
			static let itemTimerTitle = NSLocalizedString("ContactDiary_Information_Item_Timer_Title", comment: "")
			static let itemTextFileTitle = NSLocalizedString("ContactDiary_Information_Item_TextFile_Title", comment: "")
