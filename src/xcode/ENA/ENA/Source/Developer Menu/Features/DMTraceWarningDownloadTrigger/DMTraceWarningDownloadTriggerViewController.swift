...
class DMTraceWarningDownloadTriggerViewController: UITableViewController {
	...
	init(
		...
		self.viewModel = DMTraceWarningDownloadTriggerViewModel(
			store: store,
			client: client,
			appConfig: appConfig
		)
	...
	private let viewModel: DMTraceWarningDownloadTriggerViewModel
	...
	private func setupNavigationBar() {
		title = "Trace Warning HTTP Calls"
	}
}
#endif
