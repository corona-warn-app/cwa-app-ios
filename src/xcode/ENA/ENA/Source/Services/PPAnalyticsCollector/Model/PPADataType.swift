...
enum PPAKeySubmissionMetadata {
	...
	case hoursSinceTestResult(Int32, CoronaTestType)
	case keySubmissionHoursSinceTestRegistration(Int32?, CoronaTestType)
	case daysSinceMostRecentDateAtRiskLevelAtTestRegistration(Int32, CoronaTestType)
	case hoursSinceHighRiskWarningAtTestRegistration(Int32, CoronaTestType)
