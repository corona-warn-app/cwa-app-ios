...
class CoronaTestServiceTests: XCTestCase {
	...
	func test_When_UpdateTestResultSuccessWithExpired_Then_ContactJournalHasAnEntry() throws {
		let mockNotificationCenter = MockUserNotificationCenter()
		let client = ClientMock()
		client.onGetTestResult = { _, _, completion in
	...
	func test_When_UpdateTestResultSuccessWithInvalid_Then_ContactJournalHasAnEntry() throws {
		let mockNotificationCenter = MockUserNotificationCenter()
		let client = ClientMock()
		client.onGetTestResult = { _, _, completion in
	...
	func test_When_UpdateTestResultSuccessWithNegativ_Then_ContactJournalHasAnEntry() throws {
		let mockNotificationCenter = MockUserNotificationCenter()
		let client = ClientMock()
		client.onGetTestResult = { _, _, completion in
			completion(.success(TestResult.negative.rawValue))
