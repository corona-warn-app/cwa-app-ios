...
protocol AppNavigationControllerDelegate: class {
	...
	var preferredLargeTitleBlurEffectStyle: UIBlurEffect.Style? { get }
	var preferredLargeTitleBackgroundColor: UIColor? { get }
}

// MARK: - Default implementations

extension AppNavigationControllerDelegate {
	var preferredNavigationBarOpacity: CGFloat { 1.0 }
	var preferredLargeTitleBlurEffectStyle: UIBlurEffect.Style? { nil }
