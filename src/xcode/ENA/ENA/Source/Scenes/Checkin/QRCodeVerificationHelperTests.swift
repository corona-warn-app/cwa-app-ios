...
class QRCodeVerificationHelperTests: XCTestCase {
    ...
    func testValidURL() {
		...
		let validHostName = "https://presence-tracing.app"
		let validVersion = "CWA1"
		let redirectPath = "/lorem-ipsum#/"
		...
		let validURL = validHostName + redirectPath + validVersion + validPayload
	...
	func testInvalidURL_noVersion() {
		let appConfig = CachedAppConfigurationMock()
		let validHostName = "https://presence-tracing.app"
		let invalidVersion = "wrong"
		let redirectPath = "/lorem-ipsum#/"
		let validPayload = ""
		let validURL = validHostName + redirectPath + invalidVersion + validPayload
	...
	func testInvalidURL_WrongHost() {
		let appConfig = CachedAppConfigurationMock()
		let invalidHostName = "https://wrong.app"
		let validVersion = "CWA1"
		let redirectPath = "/lorem-ipsum#/"
		let validPayload = ""
		let validURL = invalidHostName + redirectPath + validVersion + validPayload
		let onErrorExpectation = expectation(description: "onError called")
	...
	func testInvalidURL_WrongPayload() {
		...
		let validVersion = "CWA1"
		let redirectPath = "/lorem-ipsum#/"
		let invalidPayload = "/wrong"
		let validURL = validHostName + redirectPath + validVersion + invalidPayload
		let onErrorExpectation = expectation(description: "onError called")
