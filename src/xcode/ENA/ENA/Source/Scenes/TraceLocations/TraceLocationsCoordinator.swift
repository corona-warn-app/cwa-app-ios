...
class TraceLocationsCoordinator {
	...
	private var tmpTraceLocation1 = TraceLocation(id: "1".data(using: .utf8) ?? Data(), version: 0, type: .locationTypeUnspecified, description: "Current single-day event", address: "Street 2, 12345 City", startDate: Date(timeIntervalSince1970: 1616803862), endDate: Date(timeIntervalSince1970: 1616805862), defaultCheckInLengthInMinutes: 30, cryptographicSeed: Data(), cnMainPublicKey: Data())
	private var tmpTraceLocation2 = TraceLocation(id: "2".data(using: .utf8) ?? Data(), version: 0, type: .locationTypeUnspecified, description: "Current multi-day event", address: "Street 3, 12345 City", startDate: Date(timeIntervalSince1970: 1616803862), endDate: Date(timeIntervalSince1970: 1616903862), defaultCheckInLengthInMinutes: 30, cryptographicSeed: Data(), cnMainPublicKey: Data())
	private var tmpTraceLocation3 = TraceLocation(id: "3".data(using: .utf8) ?? Data(), version: 0, type: .locationTypeUnspecified, description: "Location", address: "Street 4, 12345 City", startDate: nil, endDate: nil, defaultCheckInLengthInMinutes: 30, cryptographicSeed: Data(), cnMainPublicKey: Data())
