				...
				DynamicSection.section(
					cells: [
						...
						ExposureSubmissionDynamicCell.stepCell(
							...
							accessibilityLabel: String(format: AppStrings.ExposureSubmissionHotline.callButtonTitleFormat, AppStrings.ExposureSubmissionHotline.phoneNumberDomestic),
						...
						ExposureSubmissionDynamicCell.stepCell(
							...
							accessibilityLabel: String(format: AppStrings.ExposureSubmissionHotline.callButtonTitleFormat, AppStrings.ExposureSubmissionHotline.phoneNumberForeign),
							accessibilityTraits: [.button],
							hairline: .topAttached,
							bottomSpacing: .small,
