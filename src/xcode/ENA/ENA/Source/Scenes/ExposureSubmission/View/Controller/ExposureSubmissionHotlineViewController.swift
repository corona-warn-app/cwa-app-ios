				...
				DynamicSection.section(
					cells: [
						...
						ExposureSubmissionDynamicCell.stepCell(
							...
							accessibilityLabel: "\(AppStrings.ExposureSubmissionHotline.callButtonTitle)\(AppStrings.ExposureSubmissionHotline.phoneNumberDomestic)",
						...
						ExposureSubmissionDynamicCell.stepCell(
							...
							accessibilityLabel: "\(AppStrings.ExposureSubmissionHotline.callButtonTitle)\(AppStrings.ExposureSubmissionHotline.phoneNumberForeign)",
							accessibilityTraits: [.button],
							hairline: .topAttached,
							bottomSpacing: .small,
