...
extension ExpsureSubmissionNavigationController {
    ...
    private func didTapButton() {
        if let submissionController = topViewController as? ExposureSubmissionTanInputViewController {
            submissionController.exposureSubmissionService = self.exposureSubmissionService
        }
