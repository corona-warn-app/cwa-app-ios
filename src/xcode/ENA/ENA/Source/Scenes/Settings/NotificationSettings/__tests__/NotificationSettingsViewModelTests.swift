...
class NotificationSettingsViewModelTests: CWATestCase {
	...
	func testGIVEN_ViewModel_WHEN_NotificationsOff_THEN_CorrectNumberOfCells() {
		...
		let numberOfRowsInSection0 = viewModel.dynamicTableViewModelNotificationOff.numberOfRows(section: 0)
		let numberOfRowsInSection1 = viewModel.dynamicTableViewModelNotificationOff.numberOfRows(section: 1)
		let numberOfRowsInSection2 = viewModel.dynamicTableViewModelNotificationOff.numberOfRows(section: 2)
