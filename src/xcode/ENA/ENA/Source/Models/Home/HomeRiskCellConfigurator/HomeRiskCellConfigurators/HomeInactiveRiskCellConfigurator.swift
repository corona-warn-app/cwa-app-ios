...
final class HomeInactiveRiskCellConfigurator: HomeRiskCellConfigurator {
	...
	func configure(cell: RiskInactiveCollectionViewCell) {
		...
		let item2 = HomeRiskImageItemViewConfigurator(title: dateTitle, titleColor: titleColor, iconImageName: "Icons_Aktualisiert-Light", iconTintColor: iconTintColor, color: color, separatorColor: separatorColor)
