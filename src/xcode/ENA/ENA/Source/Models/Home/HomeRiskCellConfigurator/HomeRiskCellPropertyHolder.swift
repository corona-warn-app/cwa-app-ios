...
final class HomeRiskCellPropertyHolder {
    ...
    static func propertyHolder(for riskLevel: RiskLevel, dateString: String?, numberRiskContacts: String, lastContactDateString: String) -> HomeRiskCellPropertyHolder {
        switch riskLevel {
        case .unknown:
