...
struct Apple2_TemporaryExposureKeyExport {
  ...
  var signatureInfos: [Apple2_SignatureInfo] = []

  /// The temporary exposure keys themselves.
  var keys: [Apple2_TemporaryExposureKey] = []
...
struct Apple2_TemporaryExposureKey {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Apple2_TEKSignatureList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Information about associated signatures.
  var signatures: [Apple2_TEKSignature] = []
...
struct Apple2_TEKSignature {
  ...
  var signatureInfo: Apple2_SignatureInfo {
    get {return _signatureInfo ?? Apple2_SignatureInfo()}
  ...
  fileprivate var _signatureInfo: Apple2_SignatureInfo? = nil
  fileprivate var _batchNum: Int32? = nil
  fileprivate var _batchSize: Int32? = nil
...
fileprivate let _protobuf_package = "apple2"

extension Apple2_TemporaryExposureKeyExport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Apple2_TemporaryExposureKeyExport, rhs: Apple2_TemporaryExposureKeyExport) -> Bool {
...
extension Apple2_SignatureInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Apple2_SignatureInfo, rhs: Apple2_SignatureInfo) -> Bool {
...
extension Apple2_TemporaryExposureKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Apple2_TemporaryExposureKey, rhs: Apple2_TemporaryExposureKey) -> Bool {
...
extension Apple2_TEKSignatureList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Apple2_TEKSignatureList, rhs: Apple2_TEKSignatureList) -> Bool {
...
extension Apple2_TEKSignature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Apple2_TEKSignature, rhs: Apple2_TEKSignature) -> Bool {
