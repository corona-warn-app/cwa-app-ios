...
extension SAP_Internal_V2_ApplicationConfigurationAndroid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    13: .same(proto: "presenceTracingParameters"),
    14: .same(proto: "coronaTestParameters"),
    15: .same(proto: "dgcParameters"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 13: try { try decoder.decodeSingularMessageField(value: &_storage._presenceTracingParameters) }()
        case 14: try { try decoder.decodeSingularMessageField(value: &_storage._coronaTestParameters) }()
        case 15: try { try decoder.decodeSingularMessageField(value: &_storage._dgcParameters) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._diagnosisKeysDataMapping {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      } }()
      try { if let v = _storage._dailySummariesConfig {
