...
// Source: internal/v2/ppdd_srs_parameters.proto
//
...
struct SAP_Internal_V2_PPDDSelfReportSubmissionParametersIOS {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var common: SAP_Internal_V2_PPDDSelfReportSubmissionParametersCommon {
  ...
  fileprivate var _common: SAP_Internal_V2_PPDDSelfReportSubmissionParametersCommon? = nil
  fileprivate var _ppac: SAP_Internal_V2_PPDDPrivacyPreservingAccessControlParametersIOS? = nil
}

struct SAP_Internal_V2_PPDDSelfReportSubmissionParametersAndroid {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SAP_Internal_V2_PPDDSelfReportSubmissionParametersCommon {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var timeSinceOnboardingInHours: Int32 = 0
...
extension SAP_Internal_V2_PPDDSelfReportSubmissionParametersIOS: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PPDDSelfReportSubmissionParametersIOS"
  ...
  static func ==(lhs: SAP_Internal_V2_PPDDSelfReportSubmissionParametersIOS, rhs: SAP_Internal_V2_PPDDSelfReportSubmissionParametersIOS) -> Bool {
...
extension SAP_Internal_V2_PPDDSelfReportSubmissionParametersAndroid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PPDDSelfReportSubmissionParametersAndroid"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "common"),
    2: .same(proto: "ppac"),
  ]
  ...
  static func ==(lhs: SAP_Internal_V2_PPDDSelfReportSubmissionParametersAndroid, rhs: SAP_Internal_V2_PPDDSelfReportSubmissionParametersAndroid) -> Bool {
    if lhs._common != rhs._common {return false}
    if lhs._ppac != rhs._ppac {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension SAP_Internal_V2_PPDDSelfReportSubmissionParametersCommon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PPDDSelfReportSubmissionParametersCommon"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
