...
// Source: internal/ppdd/srs_otp_request_ios.proto
//
...
struct SAP_Internal_Ppdd_SRSOneTimePasswordRequestIOS {
  ...
  var payload: SAP_Internal_Ppdd_SRSOneTimePassword {
    get {return _payload ?? SAP_Internal_Ppdd_SRSOneTimePassword()}
  ...
  fileprivate var _payload: SAP_Internal_Ppdd_SRSOneTimePassword? = nil
}

#if swift(>=5.5) && canImport(_Concurrency)
extension SAP_Internal_Ppdd_SRSOneTimePasswordRequestIOS: @unchecked Sendable {}
...
extension SAP_Internal_Ppdd_SRSOneTimePasswordRequestIOS: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SRSOneTimePasswordRequestIOS"
