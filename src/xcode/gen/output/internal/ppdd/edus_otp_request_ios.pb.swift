...
// Source: internal/ppdd/edus_otp_request_ios.proto
//
...
struct SAP_Internal_Ppdd_EDUSOneTimePasswordRequestIOS {
...
extension SAP_Internal_Ppdd_EDUSOneTimePasswordRequestIOS: @unchecked Sendable {}
...
extension SAP_Internal_Ppdd_EDUSOneTimePasswordRequestIOS: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EDUSOneTimePasswordRequestIOS"
  ...
  static func ==(lhs: SAP_Internal_Ppdd_EDUSOneTimePasswordRequestIOS, rhs: SAP_Internal_Ppdd_EDUSOneTimePasswordRequestIOS) -> Bool {
