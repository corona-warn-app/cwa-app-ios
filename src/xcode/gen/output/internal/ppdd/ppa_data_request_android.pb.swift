...
// Source: internal/ppdd/ppa_data_request_android.proto
//
...
struct SAP_Internal_Ppdd_PPADataRequestAndroid {
  ...
  var payload: SAP_Internal_Ppdd_PPADataAndroid {
    get {return _payload ?? SAP_Internal_Ppdd_PPADataAndroid()}
  ...
  fileprivate var _payload: SAP_Internal_Ppdd_PPADataAndroid? = nil
}
...
extension SAP_Internal_Ppdd_PPADataRequestAndroid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PPADataRequestAndroid"
  ...
  static func ==(lhs: SAP_Internal_Ppdd_PPADataRequestAndroid, rhs: SAP_Internal_Ppdd_PPADataRequestAndroid) -> Bool {
