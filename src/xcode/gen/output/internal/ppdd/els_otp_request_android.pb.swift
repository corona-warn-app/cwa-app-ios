...
// Source: internal/ppdd/els_otp_request_android.proto
//
...
struct SAP_Internal_Ppdd_ELSOneTimePasswordRequestAndroid {
...
extension SAP_Internal_Ppdd_ELSOneTimePasswordRequestAndroid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ELSOneTimePasswordRequestAndroid"
  ...
  static func ==(lhs: SAP_Internal_Ppdd_ELSOneTimePasswordRequestAndroid, rhs: SAP_Internal_Ppdd_ELSOneTimePasswordRequestAndroid) -> Bool {
