...
struct SAP_Internal_KeyDownloadParametersIOS {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var cachedDayPackagesToUpdateOnEtagMismatch: [SAP_Internal_DayPackageMetadata] = []

  var cachedHourPackagesToUpdateOnEtagMismatch: [SAP_Internal_HourPackageMetadata] = []
...
struct SAP_Internal_KeyDownloadParametersAndroid {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SAP_Internal_DayPackageMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SAP_Internal_HourPackageMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SAP_Internal_KeyDownloadParametersIOS: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Internal_KeyDownloadParametersIOS, rhs: SAP_Internal_KeyDownloadParametersIOS) -> Bool {
...
extension SAP_Internal_KeyDownloadParametersAndroid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Internal_KeyDownloadParametersAndroid, rhs: SAP_Internal_KeyDownloadParametersAndroid) -> Bool {
    if lhs.cachedDayPackagesToUpdateOnEtagMismatch != rhs.cachedDayPackagesToUpdateOnEtagMismatch {return false}
    if lhs.cachedHourPackagesToUpdateOnEtagMismatch != rhs.cachedHourPackagesToUpdateOnEtagMismatch {return false}
...
extension SAP_Internal_DayPackageMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Internal_DayPackageMetadata, rhs: SAP_Internal_DayPackageMetadata) -> Bool {
...
extension SAP_Internal_HourPackageMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Internal_HourPackageMetadata, rhs: SAP_Internal_HourPackageMetadata) -> Bool {
    if lhs.region != rhs.region {return false}
    if lhs.date != rhs.date {return false}
