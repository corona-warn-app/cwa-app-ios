// This is a static copy of the app configuration as of 2020-09-06.
// Due to missing API versioning we had to create this thing.
// If interoperability is fully deployed, feel free to remove this file and switch to the newer specification.
