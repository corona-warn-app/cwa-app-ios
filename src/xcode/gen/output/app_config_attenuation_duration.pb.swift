...
// Source: app_config_attenuation_duration.proto
//
...
struct SAP_AttenuationDuration {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var thresholds: SAP_Thresholds {
    get {return _thresholds ?? SAP_Thresholds()}
  ...
  var weights: SAP_Weights {
    get {return _weights ?? SAP_Weights()}
  ...
  fileprivate var _thresholds: SAP_Thresholds? = nil
  fileprivate var _weights: SAP_Weights? = nil
}

struct SAP_Thresholds {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SAP_AttenuationDuration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_AttenuationDuration, rhs: SAP_AttenuationDuration) -> Bool {
...
extension SAP_Thresholds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Thresholds, rhs: SAP_Thresholds) -> Bool {
...
extension SAP_Weights: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_Weights, rhs: SAP_Weights) -> Bool {
