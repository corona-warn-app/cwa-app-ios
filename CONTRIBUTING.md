...
* Relevant coding style guidelines were configured using [SwiftLint](https://github.com/realm/SwiftLint), [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) and [AnyLint](https://github.com/Flinesoft/AnyLint). Please make sure to have them installed and run them in the `src/xcode/ENA` subdirectory via the command `./lint.sh`.
